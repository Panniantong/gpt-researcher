...
# 基础信息获取提示词
BASIC_INFO_PROMPT = """
请从给定的网页内容中提取以下产品基础信息：
1. 产品名称 (Name)
2. 官方一句话描述/Tagline (One-liner) - 保留原文
3. 产品类型/领域 (Type)
4. 官方网址 (URL)
5. 发布状态 (Launch Status) - Beta/正式版/MVP等
6. 创立时间 (Founded) - 如果可以找到
7. 团队规模 (Team Size) - 独立开发者/小团队(2-5人)/中型团队(6-20人)/大团队(20+人)
